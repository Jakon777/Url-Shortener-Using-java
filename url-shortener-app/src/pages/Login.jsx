...
export default function Login() {
  ...
  return (
    <div className="max-w-sm mx-auto mt-10 p-4 border rounded shadow">
      <h2 className="text-[green] text-xl font-bold mb-4">Login</h2>
      ...
      <div className="mt-2 text-sm">No account? <Link to="/register" className="text-blue-600">Register</Link></div>
    </div>
  );
}
